...
const symbolRules = [
	...
	pathFrameSymbol("CLEF TREBLE", "M c     c   -  -c - - - - -c- - - - - -c -  -  -c -  - - -c- - - - - -c-  -  - c     c   -  -c - - - - -c-  -  - c -  -  -c     c     c     c  -  - c- - - - - -c-  -  - c     c-  -  - c-  -  - c     c     c -  -  -c - - - - -c -  -  -zM -c     c  -  - c -  -  -zM c -  -  -c     c-  -  - c- - - - - -c -  -  -c -  -  -c - - - - -c-  -  - c-  -  - c     c-  -  - c- - - - - -zM c- - - - - -c -  -  -c     c  -  - z"),
	pathFrameSymbol("CLEF TREBLE", "M c     c   -  -c - - - - -c- - - - - -c -  -  -c -  - - -c- - - - - -c-  -  - c     c   -  -c - - - - -c-  -  - c -  -  -hc     c     c  -  - c- - - - - -c-  -  - c     c-  -  - c-  -  - c     c-     -c -  -  -c - - - - -c -  -  -zM -c     c  -  - c -  -  -zM c -  -  -c     c-  -  - c- - - - - -c -  -  -c -  -  -c - - - - -c-  -  - c-  -  - c     c-  -  - c- - - - - -zM c- - - - - -c -  -  -c     c  -  - z"),
	pathFrameSymbol("CLEF TREBLE", "M -l- -h-c-  -  - c     c   -  -c - - - - -c-  -  - c -  -  -hzM c     c   -  -c - - - - -c- - - - - -c -  -  -c - - - - -c- - - - - -l c     c     c  -  - c- - - - - -c-  -  - c     c-  -  - c-  -  - c     c     -c -  -  -c - - - - -c -  -  -zM -c     c  -  - c -  -  -zM c -  -  -c     c-  -  - c- - - - - -c -  -  -c -  -  -c - - - - -c-  -  - c-  -  - c     c-  -  - c- - - - - -zM c  -  - c- - - - - -c -  -  -c     z"),
	...
	pathFrameSymbol("CLEF BASS", "M -c     s -  -s- - - -s-  - zM c     s -  -s- - - -s-  - zM c   -  -c - - - - -c- - - - - -c-  -  - c     c     c  -  - c-  - - - -c     c   -  -c - - - - -c-  -  - c     z"),
	...
	pathFrameSymbol("ALTER SHARP", "M -c - - - - -s-  - vl- -v-c - - - - -s-  - vl- -c- - - - - -c-  -  - vc     l vl- -c- - - - - -c-  -  - vc     l vc     s -  -v-l vc     s -  -v-l c     c   -  -v-c - - - - -l- -v-l c     c   -  -v-c - - - - -l- -v-zM v-l vz"),
