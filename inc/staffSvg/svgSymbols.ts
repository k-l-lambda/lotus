...
const symbolRules: SymbolizeRule[] = [
	...
	glyphSymbol("NOTETAIL", "flags.u3"),
	glyphSymbol("NOTETAIL", "flags.u4"),
	glyphSymbol("NOTETAIL", "flags.u5"),
	glyphSymbol("NOTETAIL", "flags.u6"),
	glyphSymbol("NOTETAIL", "flags.u7"),
	glyphSymbol("NOTETAIL", "flags.u8"),
	glyphSymbol("NOTETAIL", "flags.d3"),
	glyphSymbol("NOTETAIL", "flags.d4"),
	glyphSymbol("NOTETAIL", "flags.d5"),
	glyphSymbol("NOTETAIL", "flags.d6"),
	glyphSymbol("NOTETAIL", "flags.d7"),
	glyphSymbol("NOTETAIL", "flags.d8"),
