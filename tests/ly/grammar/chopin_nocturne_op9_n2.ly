...
obsolete-between-system-padding = 1  
      %system-system-spacing #'padding = #(/ obsolete-between-system-padding staff-space)  
      %score-system-spacing #'padding = #(/ obsolete-between-system-padding staff-space)
obsolete-between-system-space = 3  
