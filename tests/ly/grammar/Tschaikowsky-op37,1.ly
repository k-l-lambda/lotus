...
\header {
  ...
  title = \markup {
"Ð¯Ð½Ð²Ð°Ñ€ÑŒ. Ð£ ÐºÐ°Ð¼ÐµÐ»ÑŒÐºÐ°"}
  subtitle = "January. Before the chimney."
  opus = "op. 37,1"
  composer = "ÐŸÐµÑ‚Ñ€ Ð˜. Ð§Ð°Ð¹ÐºÐ¾Ð²ÑÐºÐ¸Ð¹"
...
%Der hat mich viel Zeit gekostet!Macht den Takt zu einem 6/8-Takt!War als Score, jetzt nur auf Voice beschrÃ¤nkt
...
dynamica = {s4\p s\< s
	...
	s4\p s\< s 
	s s2\!
	s2._\markup{\italic {poco piÃ¹} \dynamic f }
	s2.
